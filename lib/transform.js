...
var Transform = module.exports = function(){
	...
	var test = fileEvents.on('donebitmap', function(data) {
	  ...
	  var bitmapObject1 = this.buildObject(data);
	  console.log(bitmapObject1);
	  Array.prototype.forEach.call(bitmapObject1.colorTable, function(byte, index) {
	    bitmapObject1.colorTable.writeUInt8(255 - byte, index);
	  });
	  data.writeUIntLE(bitmapObject1.colorTable, 54);
